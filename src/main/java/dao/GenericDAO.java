...
public class GenericDAO {
    ...
    public Object getByString(Class classe, String valorString, String atributo) throws HibernateException {
        Session sessao = null;
        Object objReturn = null;
        try {
            sessao = ConexaoHibernate.getSessionFactory().openSession();
            ...
            CriteriaQuery<Object> query = builder.createQuery(classe);
            Root<Object> root = query.from(classe);
            query.select(root).where(builder.equal(root.get(atributo), valorString));

            objReturn = sessao.createQuery(query).getSingleResult();
